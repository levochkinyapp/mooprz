...
type FooterProps = {
  /** Скрыть иконки (булавка, телефон, конверт) в блоке «Контакты» */
  hideContactIcons?: boolean;
  /** Скрыть блок «Следите за нами в социальных сетях» (VK, Telegram) */
  hideSocialLinks?: boolean;
};

export default function Footer({ hideContactIcons, hideSocialLinks }: FooterProps = {}) {
  const currentYear = new Date().getFullYear();

  return (
    <footer className="site-footer text-gray-600 mt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          {/* Contact — единый вид на всех страницах (цвет через .site-footer в global.css) */}
          <div>
            <h3 className="font-bold text-base sm:text-lg mb-4">Контакты</h3>
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-3">
                {!hideContactIcons && (
                  <div data-footer-contact-icon className="w-10 h-10 rounded-lg flex items-center justify-center shrink-0">
              ...
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+74991385134" className="text-gray-600 hover:text-gray-900 transition-colors">
                  +7 (499) 138-51-34
                </a>
              </div>
              <div className="flex items-center gap-3">
            ...
            <div className="flex items-center justify-between flex-col md:flex-row gap-4">
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="w-10 h-10 bg-[#2196F3] hover:bg-[#1976D2] rounded-full transition-colors flex items-center justify-center"
                  title="VK"
                  aria-label="VK"
                >
                  <span className="text-white font-bold text-sm leading-tight">VK</span>
                </a>
                <a
                  href="https://t.me"
                  target="_blank"
